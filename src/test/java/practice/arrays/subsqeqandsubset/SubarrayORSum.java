...
public class SubarrayORSum {
    public static void main(String[] args) {
        ...
        for (int i=0;i<n;i++){
           double modMaxVal = (Math.pow(2,i))%mod;
           double modMinVal = (Math.pow(2,n-(i+1)))%mod;
           maxSum = ((modMaxVal)*(A.get(i)))%mod;
           minSum = (long) (((modMinVal)*(A.get(i)))%mod);
           sum += (maxSum)-(minSum);
           sum %= mod;
        }
